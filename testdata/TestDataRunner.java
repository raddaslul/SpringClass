...
// 테스트 User 생성
        ...
        User testUser2 = new User("제이홉", passwordEncoder.encode("123"), "ugar@sparta.com", UserRoleEnum.USER);
        User testAdminUser = new User("아미", passwordEncoder.encode("123"), "gar@sparta.com", UserRoleEnum.ADMIN);
